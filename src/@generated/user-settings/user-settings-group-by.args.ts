...
import { UserSettingsAvgAggregateInput } from './user-settings-avg-aggregate.input';
import { UserSettingsSumAggregateInput } from './user-settings-sum-aggregate.input';
...
export class UserSettingsGroupByArgs {
    ...
    @Field(() => UserSettingsAvgAggregateInput, {nullable:true})
    _avg?: UserSettingsAvgAggregateInput;

    @Field(() => UserSettingsSumAggregateInput, {nullable:true})
    _sum?: UserSettingsSumAggregateInput;
