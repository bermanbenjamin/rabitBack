...
import { HabitIntervalCreateNestedOneWithoutHabitInput } from '../habit-interval/habit-interval-create-nested-one-without-habit.input';

@InputType()
export class HabitCreateWithoutReminderInput {
    ...
    @Field(() => HabitIntervalCreateNestedOneWithoutHabitInput, {nullable:false})
