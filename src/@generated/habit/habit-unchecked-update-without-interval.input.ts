...
import { HabitReminderUncheckedUpdateManyWithoutHabitNestedInput } from '../habit-reminder/habit-reminder-unchecked-update-many-without-habit-nested.input';

@InputType()
export class HabitUncheckedUpdateWithoutIntervalInput {
    ...
    @Field(() => HabitReminderUncheckedUpdateManyWithoutHabitNestedInput, {nullable:true})
    reminder?: HabitReminderUncheckedUpdateManyWithoutHabitNestedInput;
}
