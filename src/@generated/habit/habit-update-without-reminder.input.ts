...
import { HabitIntervalUpdateOneRequiredWithoutHabitNestedInput } from '../habit-interval/habit-interval-update-one-required-without-habit-nested.input';

@InputType()
export class HabitUpdateWithoutReminderInput {
    ...
    @Field(() => HabitIntervalUpdateOneRequiredWithoutHabitNestedInput, {nullable:true})
