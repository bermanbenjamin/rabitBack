...
import { RoutineUncheckedUpdateManyWithoutUserNestedInput } from '../routine/routine-unchecked-update-many-without-user-nested.input';
...
export class UserUncheckedUpdateWithoutUserSettingsInput {
    ...
    @Field(() => RoutineUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
