...
import { ToDoSubtaskUncheckedUpdateManyWithoutToDoTaskNestedInput } from '../to-do-subtask/to-do-subtask-unchecked-update-many-without-to-do-task-nested.input';

@InputType()
export class ToDoTaskUncheckedUpdateWithoutToDoListInput {
    ...
    @Field(() => ToDoSubtaskUncheckedUpdateManyWithoutToDoTaskNestedInput, {nullable:true})
    subTasks?: ToDoSubtaskUncheckedUpdateManyWithoutToDoTaskNestedInput;
}
